...
namespace TripYari.Core.Data.DataContextScope.Entity
{
    ...
    public class RegisteredDbContextFactory : IDbContextFactory
    {
        ...
        public void RegisterDbContextType<TDbContext>(Func<TDbContext> createDbContextFunc) where TDbContext : IUnitOfDbContext
        {
        ...
        public TDbContext CreateDbContext<TDbContext>() where TDbContext : IUnitOfDbContext
        {
