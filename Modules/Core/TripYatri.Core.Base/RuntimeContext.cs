...
namespace TripYatri.Core.Base
{
    public class RuntimeContext
    {
        ...
        public RuntimeContext(RuntimeEnvironment currentEnvironment)
        {
        ...
        public RuntimeContext(RuntimeEnvironment currentEnvironment, IServiceProvider serviceProvider)
        {
